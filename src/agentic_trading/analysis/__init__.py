"""Technical analysis and trade planning utilities.

This package provides pre-trade analysis tools:

- **R:R calculation** — multi-target risk-reward ratios and PnL projection
