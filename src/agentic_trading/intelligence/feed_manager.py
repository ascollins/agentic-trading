...
* Incoming raw OHLCV data is normalized via :mod:`agentic_trading.intelligence.normalizer`
  and optionally aggregated by :class:`agentic_trading.intelligence.candle_builder.CandleBuilder`.
...
from agentic_trading.intelligence.normalizer import (
    candle_to_event,
